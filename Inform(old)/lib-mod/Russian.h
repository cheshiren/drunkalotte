...
Constant LanguageVersion = "@<<Информ@>>: Русская версия 0.75, сентябрь 2004";
...
CompassDirection -> ne_obj "северо-восток/"
                    with name 'ne' 'св' 'северовосток',
		    door_dir ne_to;
CompassDirection -> nw_obj "северо-запад/"
                    with name 'nw' 'сз' 'северозапад',
		    door_dir nw_to;
CompassDirection -> se_obj "юго-восток/"
                    with name 'se' 'юв' 'юговосток',
		    door_dir se_to;
CompassDirection -> sw_obj "юго-запад/"
                    with name 'sw' 'юз' 'югозапад',
		    door_dir sw_to;
...
Constant IS__TX       = " имеется";
Constant ARE__TX      = " имеются";
Constant IS2__TX      = "имеется ";
Constant ARE2__TX     = "имеются ";
Constant AND__TX      = " и ";
